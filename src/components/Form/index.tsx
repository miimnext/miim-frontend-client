...
const Form = forwardRef<FormRef, FormProps>(({ onSubmit, children, form, onValidityChange, rules = {} }, ref) => {
  const [formData, setFormData] = useState<{ [key: string]: string | string[] }>(form);
